	...
	<div class="body">
		<div class="register">
			...
			<el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
				<el-form-item label="用户名" prop="name" class="name">
					<el-input type="txt" v-model="ruleForm.name" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="昵称" prop="nickName" class="nickName">
					<el-input type="txt" v-model="ruleForm.nickName" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="密保问题" prop="question" class="question">
					<el-input type="txt" v-model="ruleForm.question" autocomplete="off"></el-input>
				</el-form-item>
        <el-form-item label="密保问题答案" prop="answer" class="answer">
					<el-input type="txt" v-model="ruleForm.answer" autocomplete="off"></el-input>
				</el-form-item>
