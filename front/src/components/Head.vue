<template>
	...
	<div class="head">
		...
		<!-- 搜索框 -->
		<div class="search">
			<el-input class="search-ipt" placeholder="请输入内容" v-model="input" clearable> </el-input>
		...
		<ul class="nav">
			...
			<li>
				<router-link to="/hot">
					<svg class="icon" aria-hidden="true">
						<use xlink:href="#icon-redu" style="color: #fc3847"></use>
					</svg>
					热榜
				</router-link>
			</li>
			...
			<li class="li-blog">
				<!-- 发布博客 -->
				<router-link to="/editBlog" class="blog">
					<svg class="icon" aria-hidden="true">
